...
class ListGroupAdapter(val itemList: ArrayList<GroupItem>, val nc: NavController):
    ...
    override fun onBindViewHolder(holder: ListGroupViewHolder, position: Int) {
        ...
        holder.tv_food.text = "${itemList[position].food}개"
        holder.tv_route.text = "${itemList[position].route}개"
